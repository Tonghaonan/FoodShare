  ...
  <body>
    <aside class="probootstrap-aside js-probootstrap-aside">
      ...
      <div class="probootstrap-site-logo probootstrap-animate" data-animate-effect="fadeInLeft">
        ...
        <a href="${pageContext.request.contextPath}/toIndex" class="mb-2 d-block probootstrap-logo">美食分享</a>
          <c:if test="${user1!=null}">
              <p class="mb-0"><img style="height: 30px ;width: 30px" src="${pageContext.request.contextPath}/static/${user1.image}" />
                  <a href="${pageContext.request.contextPath}/toEditUserInfo" target="_blank">欢迎 ${user1.username} !</a></p>
          </c:if>
          <c:if test="${user1==null}">
